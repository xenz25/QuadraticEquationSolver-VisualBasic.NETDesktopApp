Public Class History
    ...
    Private Sub Button_save_history_Click(sender As Object, e As EventArgs) Handles Button_save_history.Click
        If ListBox_history.Items.Count = 1 Then 'when no history data yet
            MessageBox.Show("There are no history yet." & vbNewLine & "Cannot save.", "Quadratic Equation", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Else
            Try
    ...
    Private Sub Button_copyhis_Click(sender As Object, e As EventArgs) Handles Button_copyhis.Click
        ...
        Catch ex As Exception
            MessageBox.Show("There are no history yet." & vbNewLine & "No data copied.", "Quadratic Equation", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End Try
    End Sub
